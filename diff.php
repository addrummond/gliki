...
/*
 * Somewhat hacked about PHP file from the Wikimedia code.
...
function wfProfileIn($x) { ; }
function wfProfileOut($x) { ; }
...
class _DiffOp_Copy extends _DiffOp {
	...
	function reverse() {
        ...
        function __toString() {
                $o = strarray($this->orig);
                $c = strarray($this->closing);
                return "Copy(orig: $o, closing:, $c)";
        }
}
...
class _DiffOp_Delete extends _DiffOp {
	...
	function reverse() {
        ...
        function __toString() {
                $o = strarray($this->orig);
                $c = strarray($this->closing);
                return "Delete(orig: $o, closing:, $c)";
        }
}
...
class _DiffOp_Change extends _DiffOp {
	...
	function reverse() {
        ...
        function __toString() {
                $o = strarray($this->orig);
                $c = strarray($this->closing);
                return "Change(orig: $o, closing:, $c)";
        }
}
